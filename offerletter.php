...
$notice_period_html='<p>You  need  to  serve  minimum  of  15  days  to  the  organization.  You  need  to  give  100%  support,
knowledge transfer, team transfer, client transfer and responsibilities to your reporting manager atleast
before the last day of the notice period.</p><br>';
...
$termination_html='Employee will be terminated from the Company for any bad behavior or irresponsible about timelines
by giving 15 days of notice.<br>';
$pdf->SetFont('Times', 'B', 12);
$pdf->Cell(190, 4, "", 0, 1);
