...
if(!empty($_POST['entity_name']))
{
	...
	$pagerarray['preferred_work_type'] = mysqli_real_escape_string($conn,$_POST['preferred_work_type']);
												...
												<table class="table table-bordered table-hover table-checkable" id="kt_table_1">
													...
													<?php for($i=0;$i<count($entity);$i++){?>
														<tr>
															...
															<td><?= $entity[$i]['preferred_work_type']; ?></td>
				...
				<form method="post" action="" enctype="multipart/form-data" id="addentityform" autocomplete="off">
					<div class="row">
						...
						<div class="col-6">    
							...
							<input class="form-control" name="preferred_work_type" type="text" placeholder="Enter Entity Preferred Work Type" id="preferred_work_type" required>
						</div>
						<div class="col-6">    
