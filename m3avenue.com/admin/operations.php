			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
						<div class="kt-portlet__head row">
							<div class="kt-portlet__head-label col-lg-3 col-md-4 col-sm-4 col-xs-12">
								<h3 class="kt-portlet__head-title">Operations Employee List</h3>
							</div>
												...
												<table class="table table-bordered table-hover table-checkable" id="kt_table_1">
													...
													<tbody>
														...
														$x=1;  foreach($sql as $row)
														{
															...
															<td>
															<a class="btn btn-info" data-toggle="modal" data-target="#configureModal">Configure</a>
				...
				<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
					<div class="modal-dialog modal-dialog-scrollable h-75 w-100 modal-lg"  role="document">
									...
									<div class="row">
										...
										<div class="row mt-2">
											...
											<div class="col">
												...
												<select class="form-control" name="role" type="text" required>
													<option value="role 1">Male</option>
													<option value="role 1">Female</option>
												</select>
											</div>
										</div>
										<div class="row mt-2">
										...
										<div class="row mt-2">
											<div class="col">
												...
												<input class="form-control" type="text" name="email" placeholder="Enter employee email" id="email" required>  
											</div>
											<div class="col">
										...
										<div class="row mt-2">
											<div class="col">
												...
												<input class="form-control" type="password" name="email" placeholder="Enter employee email" id="email" required>  
											</div>
											<div class="col">
										...
										<div class="row mt-2"> 
											<div class="col">
												<label for="example-text-input" class="font-weight-bold">Emergency Contact Details</label>
												<div class="form-group row">
													<div class="col-md-4">
														<input class="form-control" type="text" name="contactName" placeholder="Contact Name" id="contactName" maxlength="10">
													</div>
													<div class="col-md-4">
														<input class="form-control" type="text" name="mobileNumber" placeholder="Enter Mobile Number" id="mobileNumber" maxlength="10">
													</div>
													<div class="col-md-4">
															<input class="form-control" type="text" name="relation" placeholder="Enter Relation" id="relation">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row mt-2">
											<div class="col">
												...
												<input type="text" class="form-control" placeholder="Enter pincode" id="pincode" name="pincode" maxlength="6" required>
											</div>
											<div class="col">
										...
										<div class="row mt-2">
											...
											<div class="col"> 
												<label for="example-text-input" class="font-weight-bold">Work Location</label>													<input class="form-control" type="text" name="location"     placeholder="Enter location" id="location" required>
											</div>
										</div>	
									</form>
						...
						<!-- The Modal -->
						<div class="modal fade" id="configureModal" tabindex="-1" role="dialog" aria-labelledby="configureModal" aria-hidden="true">
					<div class="modal-dialog modal-dialog-scrollable h-75 w-100 modal-lg"  role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalScrollableTitle">Add Configutation</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
								...
								<div class="modal-body">
										<div class="row mt-2">
											<div class="col-6">
												<label for="example-text-input" class="font-weight-bold">Service type</label>
												<div>
													<select class="js-example-basic-multiple form-control" name="serviceType[]" multiple="multiple">
														<option value="AL">Service 1</option>
														<option value="AL">Service 2</option>
														<option value="AL">Service 3</option>
														<option value="AL">Service 4</option>
														<option value="WY">Service 5</option>
													</select>
												</div>
											</div>
											<div class="col">
												
												<label for="example-text-input" class="font-weight-bold">Entity</label>
												<div>
													<select class="js-example-basic-multiple form-control" name="entity[]" multiple="multiple">
														<option value="AL">All</option>
														<option value="AL">Entity 2</option>
														<option value="AL">Entity 3</option>
														<option value="AL">Entity 4</option>
														<option value="WY">Entity 5</option>
													</select>
												</div>
											</div>   
										</div>
										<div class="row mt-2">
											<div class="col-6">
												<label for="example-text-input" class="font-weight-bold">Manager</label>
												<div>
													<select class="js-example-basic-multiple form-control" name="managers[]" multiple="multiple">
														<option value="AL">Managers 1</option>
														<option value="AL">Managers 2</option>
														<option value="AL">Managers 3</option>
														<option value="AL">Managers 4</option>
														<option value="WY">Managers 5</option>
													</select>
												</div>
											</div>
											<div class="col">
												...
												<div>
													<select class="js-example-basic-multiple form-control" name="location[]" multiple="multiple">
														<option value="AL">All</option>
														<option value="AL">location 2</option>
														<option value="AL">location 3</option>
														<option value="AL">location 4</option>
														<option value="WY">location 5</option>
													</select>
												</div>
											</div>   
										</div>
