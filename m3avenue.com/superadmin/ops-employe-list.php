...
if(!empty($_POST['fname']))
{
	...
	if(!$result){
		header("Location: ops-employe-list.php?success=success");
	}
...
$opsmanagers = runloopQuery("SELECT unique_id,concat(fname,' ',lname) leadername FROM employee where role_id = 5 and ID in ('".$empString."')  order by ID desc");
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
						<div class="kt-portlet__head row">
							<div class="kt-portlet__head-label col-lg-3 col-md-4 col-sm-4 col-xs-12">
								<h3 class="kt-portlet__head-title">Ops Team List</h3>
							</div>
													...
													<div class="form-group row">
														...
														<div class="col-7">
															<select class="form-control"  name="filter_by_role" id="filter_by_role" >
																...
																<?php 
																foreach($roles as $roleid => $rolename) { if ($roleid != '1' && $roleid != '2' && $roleid != '3' && $roleid != '4' ) {?> 
													...
													<tbody>
														...
														$x=1;  foreach($sql as $row)
														{
															...
															<td>
																...
																<?php } else { ?>
																<a href="ops-edit-employee-list.php?edit=<?php echo $row["ID"];?>">Edit</a> <?php } ?> | <a onclick="return confirm('Are you sure want to delete??');"  href="?delete=<?php echo $row["ID"];?>">Delete</a>
									...
									<div class="row">
										<div class="col-6">    
											...
											<select class="form-control"  name="role_id" id="role_id" onchange="rolebasedisplay()" required>
												...
												<?php foreach($roles as $roleid => $rolename) { if ($roleid != '1' && $roleid != '2' && $roleid != '3' && $roleid != '4' ) {?> 
