				...
				<div class="col-12"> 
					<div class="card">
						<div class="card-header">
							<h4 class="page-title" style="color:#886CC0">Loan Enquirys</h4>
							<a href="csv-loanenquires.php?table=loans"><button type="button" class="btn btn-primary" style="float:right" data-toggle="modal" data-target="#exampleModalScrollable">Download</button></a> 
						</div>
						<div class="card-body">
