					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h4 class="page-title" style="color:#886CC0">Employee report</h4>
								<button type="button" class="btn btn-primary" style="float:right" data-bs-toggle="modal"  data-toggle="modal" data-bs-target=".add_lead">Add Lead</button> 
							</div>
							<div class="card-body">
