			...
			switch($action){
			    case 'profile':
						  ...
						  foreach($employeedetails as $employeedetails){
							...
							$customerdetails['personal_email'] =  $employeedetails['personal_email'];
							$customerdetails['employeemobile'] =  $employeedetails['mobile'];
							$customerdetails['whatsapp_number'] =  $employeedetails['whatsapp_number'];
							$customerdetails['alternate_mobile_number'] =  $employeedetails['alternate_mobile_number'];
							$customerdetails['landmark'] =  $employeedetails['landmark'];
							$customerdetails['city'] =  $employeedetails['city'];
							$customerdetails['state'] =  $employeedetails['state'];
							$customerdetails['pincode'] =  $employeedetails['pincode'];
							$customerdetails['work_location'] =  $employeedetails['location'];
