...
<body>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h4 class="page-title" style="color:#886CC0">Follow Up Leads</h4>
								<!-- <button type="button" class="btn btn-primary" style="float:right" data-toggle="modal" data-target="#exampleModalScrollable">Add Lead</button>  -->
							</div>
							<div class="card-body">
				                ...
				                <div class="table table-responsive">
                                    ...
                                    <tbody>
									  ...
									  if(!empty($_GET['employeeid'])){
										...
										$sql = runloopQuery("SELECT * FROM track_work where employee_id = '".$empid."' and doc_status in ('0','1') and date(followup) between '".$startdate."' and '".$enddate."'  order by ID desc");
										}
										else{
										$sql = runloopQuery("SELECT * FROM track_work  where date(followup) between '".$startdate."' and '".$enddate."' and doc_status in ('0','1') and employee_id in ('".$empString."') order by ID desc");
 ...
 <div class="modal fade" id="add_lead_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
