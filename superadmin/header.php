...
<!-- <li class="kt-menu__item  kt-menu__item--submenu <?php if($pagename=='loan.php'||$pagename=='investment.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
	...
	<li class="kt-menu__item  kt-menu__item--submenu  <?php if($pagename=='ops-employe-list.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
            <a href="ops-employe-list.php" class="kt-menu__link kt-menu__toggle">
             <i class="kt-menu__link-icon flaticon-avatar"></i>
            <span class="kt-menu__link-text">Ops Team List</span>
            <i class=""></i>
            </a>
    </li>	
	...
	<li class="kt-menu__item  kt-menu__item--submenu  <?php if($pagename=='points-set.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
          ...
          <li class="kt-menu__item  <?php if($pagename=='designations.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true">
					<a href="designations.php" class="kt-menu__link ">
					<i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
					<span class="kt-menu__link-text">Designations</span></a>
					</li>

		</div>
	</li> 
  <li class="kt-menu__item  kt-menu__item--submenu  <?php if($pagename=='upload-bank-excell.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
          	<a href="#" class="kt-menu__link kt-menu__toggle">
            <i class="kt-menu__link-icon flaticon-users"></i>
    ...
    <li class="kt-menu__item  kt-menu__item--submenu  <?php if($pagename=='business-entity.php'||$pagename=='entity-staff.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
            ...
            <span class="kt-menu__link-text">Staff</span></a>
            	 ...
            	 <li class="kt-menu__item  <?php if($pagename=='cummulative-app-track.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true">
            <a href="cummulative-app-track.php" class="kt-menu__link ">
            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
            <span class="kt-menu__link-text">Cummulative Application Tracking</span></a>
            </li>
          </ul>
		</div>
	</li>
    ...
    <li class="kt-menu__item  kt-menu__item--submenu  <?php if($pagename=='ticket_history.php'){ echo 'kt-menu__item--active';}?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
            <a href="ticket_history.php" class="kt-menu__link kt-menu__toggle">
             <i class="kt-menu__link-icon flaticon-avatar"></i>
            <span class="kt-menu__link-text">Ticket History</span>
            <i class=""></i>
            </a>
    </li>
  </ul>
