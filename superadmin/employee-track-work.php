...
if(!empty($_POST['uploaddata'])){
	...
	header("Location: employee-track-work.php?statusupdate=success");
...
<!-- end:: Subheader -->
				...
				<div class="row mx-3" style="display:flex;align-items: center;min-height:60px;">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Leads Report</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    	<button type="button" class="btn btn-primary" style="float:right" data-toggle="modal" data-target="#add_lead_modal">Add Lead</button>    
						...
						<!-- <div class="kt-portlet__head">
							<div class="kt-portlet__head-label">
								<h3 class="kt-portlet__head-title">Leads report</h3>
							</div>
						</div> -->
