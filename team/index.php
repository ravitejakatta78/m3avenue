...
$message = '';
	...
	$row = runQuery("SELECT * FROM employee WHERE email = '$mymailid' and role_id = '4' and status = '1'"); 
	} else {
	$row = runQuery("SELECT * FROM employee WHERE mobile = '$mymailid' and role_id = '4' and status = '1'"); 
	}
