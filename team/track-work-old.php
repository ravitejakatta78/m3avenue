            ...
            <div class="container-fluid">
				...
				<form  method="post" action="" enctype="multipart/form-data">	
                          <div class="form-group row">			 
								...
								<div class="col-md-4">
									<input type="text" placeholder="Lead Name" name="clientname" class="form-control form-control-line" value="<?php echo $_POST['clientname'];?>" required> 
                               </div>
					   ...
					   <div class="form-group row">
							...
							<div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                          <input type="text" placeholder="Company Name" name="company" class="form-control form-control-line" required value="<?php echo $_POST['company'];?>" > 
                                       </div>
                          ...
                          <input type="text" placeholder="Salary / income" name="income" onkeypress="return isNumberKey(event)" class="form-control form-control-line" required value="<?php echo $_POST['income'];?>" > 
							...
							<div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                          <input type="date"   name="followup" class="form-control form-control-line" required value="<?php echo $_POST['followup'] ?? date('Y-m-d');?>" min="<?= date('Y-m-d'); ?>" > 
